  ...
  if (isReadyForPickUp === false) {
    ...
    button = (
      <DeliveredBttn
        ...
        handleOnClick={handleOnDelivered}
      />
    );
  }
        ...
        <div className="wrapperOrder">
          ...
          <footer className="footer">
            <div className="ButtonsContainer">
              <CancelBttn
                isDisabled={disabledCancelState}
          ...
          <IncommingOrderView
            state={context.isIncommingOrder}
            handleOnClick={handleOnNewOrderClick}
          />
        </div>
      </div>
    </>
